...
exports.stringArrayValidator = exports.numberValidator = exports.selectValidator = exports.passwordValidator = exports.emailValidator = exports.stringValidator = void 0;
const joi_1 = __importDefault(require("joi"));
// 1. String Validator
const stringValidator = (label, min, max, required = false, patternString = /^[a-zA-Z\s]+$/) => {
...
const stringArrayValidator = (label, required = false, maxItems) => {
    let rule = joi_1.default.array()
